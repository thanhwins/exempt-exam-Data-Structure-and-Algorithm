//hang doi vong thi cai dat bang mang chu sao lai cai bang danh sach lien ket
//day la code bai hang doi binh thuong, minh khong hieu hang doi vong bang DSLK nhu the nao
#include<iostream>
using namespace std;
